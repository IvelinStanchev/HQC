    ...
    public class WalkInMatrix
    {
        ...
        private static void FillMatrix(int[,] matrix, ref int row, ref int col)
        {
            ...
            while (true)
            {
                ...
                if (!IsCollisionWithBorderDetected(matrix, row, col))
                {
                    return;
                }
        ...
        private static bool IsCollisionWithBorderDetected(int[,] arr, int x, int y)
        {
        ...
        public static void InitializeMatrix(string input)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("Not a valid range. The valid Range is [1..100]!");
            }
        }
